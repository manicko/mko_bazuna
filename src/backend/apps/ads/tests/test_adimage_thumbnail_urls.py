...
Uses SimpleTestCase with in-memory AdImage instances (no DB).
"""
...
class TestAdImageThumbnailUrls(SimpleTestCase):
    """Tests for AdImage thumbnail URL property behaviour."""

    # ── thumbnail_small_url ─────────────────────────────────────────────

    def test_thumbnail_small_url_returns_url_when_set(self) -> None:
    ...
    def test_thumbnail_small_url_returns_none_when_null(self) -> None:
        """Property returns None when thumbnail_small is None."""
        img = AdImage.__new__(AdImage)
        img.thumbnail_small = None
        assert img.thumbnail_small_url is None

    def test_thumbnail_small_url_returns_none_when_blank(self) -> None:
    ...
    def test_thumbnail_medium_url_returns_url_when_set(self) -> None:
    ...
    def test_thumbnail_medium_url_returns_none_when_null(self) -> None:
    ...
    def test_thumbnail_large_url_returns_url_when_set(self) -> None:
    ...
    def test_thumbnail_large_url_returns_none_when_null(self) -> None:
    ...
    def test_thumbnail_urls_do_not_interfere(self) -> None:
    ...
    def test_all_thumbnail_urls_return_none_when_all_empty(self) -> None:
