    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=5, help_text="Minimum title length in characters"
                    ),
                ),
                (
                    "title_max_length",
                    models.PositiveIntegerField(
                        default=100, help_text="Maximum title length in characters"
                    ),
                ),
                (
                    "description_min_length",
                    models.PositiveIntegerField(
                        default=10, help_text="Minimum description length in characters"
                    ),
                ),
                (
                ...
                (
                    "min_images",
                    models.PositiveIntegerField(
                        default=1, help_text="Minimum number of images required"
                    ),
                ),
                (
                    "max_images",
                    models.PositiveIntegerField(
                        default=5, help_text="Maximum number of images allowed"
                    ),
                ),
                (
                    "banned_words",
                ...
                (
                    "max_ads_per_user",
                    models.PositiveIntegerField(
                        default=10, help_text="Maximum active ads per user"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, help_text="Action timestamp"
                    ),
                ),
                (
                    "ad",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default=apps.core.enums.AdPriorityLevel["MEDIUM"],
                        max_length=10,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["priority_level"], name="ad_moderati_priorit_dec75a_idx"
                    ),
                    models.Index(
                        fields=["base_score"], name="ad_moderati_base_sc_bb70a8_idx"
                    ),
                    models.Index(
                        fields=["escalation_required"],
                        name="ad_moderati_escalat_6731b8_idx",
                    ),
                ],
            },
        ),
