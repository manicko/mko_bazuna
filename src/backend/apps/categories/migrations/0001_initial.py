    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="URL-friendly category slug", unique=True
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Inactive categories hide their ads"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["category", "listing_condition"],
                        name="category_li_categor_552b05_idx",
                    ),
                    models.Index(
                        fields=["listing_condition"],
                        name="category_li_listing_633363_idx",
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="category_li_categor_c12b58_idx",
                    ),
                    models.Index(
                        fields=["feature"], name="category_li_feature_3b48c5_idx"
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="category_li_categor_191baa_idx",
                    ),
                    models.Index(
                        fields=["listing_purpose"],
                        name="category_li_listing_072c49_idx",
                    ),
                ],
