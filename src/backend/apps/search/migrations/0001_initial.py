...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        db_index=True,
                        help_text="Opaque server-generated capability token for Telegram unsubscribe deep-links and inline callbacks (never derived from the PK)",
                        max_length=40,
                        null=True,
                        unique=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sent_at",
                    models.DateTimeField(
                        auto_now_add=True, help_text="When this notification was sent"
                    ),
                ),
                (
                    "ad",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user_id", "is_active"], name="IX_saved_searches_user_active"
            ),
        ),
        migrations.AddIndex(
            model_name="savedsearchnotification",
            index=models.Index(
                fields=["saved_search_id"], name="idx_saved_search_notif_sid"
            ),
        ),
        migrations.AddConstraint(
            model_name="savedsearchnotification",
            constraint=models.UniqueConstraint(
                fields=("saved_search", "ad"), name="uq_saved_search_ad"
            ),
        ),
        migrations.AddIndex(
            model_name="searchhistory",
            index=models.Index(
                fields=["user_id", "-created_at"], name="search_hist_user_id_3ea0ad_idx"
            ),
        ),
    ]
