...
| **17** | URL state (lang, city) lost on category navigation; city dropdown not linked to URL state | [Complete](.ai/problems/17_url-state-preservation_spec.md) — Signed-off (PO confirmed Q1=A, Q2=A, Q3=A, Q4=A) |
| **18** | No contact-us footer link; bot username in cleartext env var (not admin-configurable); no anti-spam protection for Telegram deep-links | [Signed-off](.ai/problems/18_contact-us_spec.md) — PO confirmed Q1=A, Q2=A, Q3=A, Q4=A, Q5=A, Q6=A, Q7=A, Q8=C |
