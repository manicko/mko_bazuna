...
| **O5** | Finding ads by category | Buyers must be able to **find ads by category name** in phase 1. | Hybrid search: denormalized category name included in the search index (weight 'C') plus fuzzy category detection; a Montenegrin query is translated to Russian before searching. | D1 / D2 |
