...
- Query translation: deep-translator (Montenegrin → Russian at search time; hard timeout ~500ms +
...
deep-translator>=1.11.0           # Montenegrin→Russian query translation. Fragile backend → hard timeout + fallback required.
