...
6. **ENT-005 (LOW) — Replace bot PID-only healthcheck.** Implement heartbeat-file or webhook-based readiness probe. Medium effort due to bot's non-HTTP architecture.
