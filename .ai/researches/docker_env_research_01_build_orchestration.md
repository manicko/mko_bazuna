...
### From `docs/03-packages/packages-list.md` (packages specification):
...
### From `docs/01-spec/architecture-structure.md` (deployment sketch):
...
### From `docs/02-database/db-schema.md` (database requirements):
...
| Component | Spec Requirement (`docs/03-packages/packages-list.md`) | Actual State (pyproject.toml) | Impact |
|-----------|------------------------------------------|-------------------------------|--------|
...
Per spec (`docs/01-spec/architecture-structure.md` lines 64-67, 94-96):
...
The spec (`docs/03-packages/packages-list.md` line 9) requires:
...
- `docs/01-spec/technical-specification.md` — Lines 18-21 (traffic/load requirements)
- `docs/03-packages/packages-list.md` — Lines 14-17, 41, 59, 64, 73, 9 (exact package versions)
- `docs/01-spec/architecture-structure.md` — Lines 64-67, 83-106 (deployment sketch)
- `docs/02-database/db-schema.md` — Lines 6, 183-184 (FTS triggers, Russian config)